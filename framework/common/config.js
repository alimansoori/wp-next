...
function withFrameworkConfig(defaultConfig = {}) {
    ...
    if (!ALLOWED_FW.includes(framework)) throw new Error(`The api framework: ${framework} cannot be found, please use one of ${ALLOWED_FW.join(", ")}`)
