            ...
            <Dropdown show={dropDownShow} onToggle={handleOnToggle}>
                ...
                <Dropdown.Menu style={{width: '450px'}}>
                                    ...
                                    <div className="cart__item">
                                        <div className="cart__item__pic">
                                            {item.product.node.image ? (
                                                <img className="cart__item__pic__img"
                                                     src={item.product.node.image.sourceUrl}
                                                     alt={item.product.node.image.altText}/>
                                            ) : (
                                                <img className="cart__item__pic__img" src={`/image/book picture.png`}
                                                     alt="book cart"/>
                                            )}
                                        </div>
                                        <div className="cart__item__details">
                                            ...
                                            <div
                                                className="cart__item__details__price">{`${PN.convertEnToPe(stringToNumber(item.product.node.price))}`}</div>
                                        </div>
                                        <div className="cart__item__options">
                                            ...
                                            <div
                                                ...
                                                className="cart__item__options__dlt">
                                                {/* {cartLoading ? (
                          <Spinner size='sm' animation="border" role="status">
                            <span className="sr-only">Loading...</span>
                          </Spinner>
                    ...
                    <div className="cart__purchase">
                        <div className="cart__purchase__price">مبلغ
                            کل: {PN.convertEnToPe(stringToNumber(cart.total))}</div>
